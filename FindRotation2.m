...
global MarkersVec EdgeVec unitVecX unitVecY unitVecZ MakersFromViconRotCalc MakersFromVicon;
...
disp('Markers from rotation calculation is:');
disp(MakersFromViconRotCalc);
